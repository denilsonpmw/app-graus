    ...
    <div className="min-h-screen bg-gradient-to-br from-solar-50 via-white to-green-50">
      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="space-x-2">
            <Button variant="outline" onClick={() => window.location.href = '/dashboard'}>Login</Button>
            <Button className="bg-solar-600 hover:bg-solar-700" onClick={() => window.location.href = '/cadastro'}>Cadastrar</Button>
          </div>
        </div>
      </header>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button size="lg" className="bg-solar-600 hover:bg-solar-700 text-lg px-8 py-3" onClick={() => window.location.href = '/cadastro'}>
            Começar Agora
          </Button>
      ...
      <section className="bg-solar-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" variant="secondary" className="bg-white text-solar-600 hover:bg-gray-100 text-lg px-8 py-3" onClick={() => window.location.href = '/cadastro'}>
            Cadastrar Agora
          </Button>
        </div>
      </section>
